...
public class NewmanResource {
    ...
    public static final String FAILING_AGENTS = "failing-agents";
    public static final String AGENT_COUNT = "agent-count";
    ...
    private Agent createAgentFromOfflineAgent(OfflineAgent agent) {
        Agent result = new Agent();
        result.setName(agent.getName());
        result.setHost(agent.getHost());
        result.setLastTouchTime(agent.getLastTouchTime());
        result.setId("");
        result.setJobId("");
        result.setHostAddress("");
        result.setPid("");
    ...
    public Batch<Agent> cleanAgentRetries(@DefaultValue("0") @QueryParam("offset") int offset,
        ...
        broadcastMessage(FAILING_AGENTS, count);
        return new Batch<>(agents, offset, limit, all, orderBy, uriInfo);
    }
    ...
    public Response subscribe(final Agent agent) {
        ...
        if (found == null) {
            ...
            broadcastMessage(AGENT_COUNT, agentDAO.count());
        }

    ...
    in
        div []
            [ div [ class "form-inline" ]
                [ oldBuildSelect
                , newBuildSelect
                , div [] [ Button.button [ Button.disabled ((model.oldBuild == "") || (model.newBuild == "")) , Button.primary, Button.onClick ClickCompareBuilds] [ text "Compare Changes" ] ]
                ]
...
viewDialog model toMsg confirmMsg =
            Modal.config toMsg
            |> Modal.large
            |> Modal.h3 [] [ text ("Compare builds " ++ model.oldBuild ++ " and " ++ model.newBuild) ]

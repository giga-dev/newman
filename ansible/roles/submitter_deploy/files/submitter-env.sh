...
export SERVICE_GRID=58872c5329f67f0c0af44113
export WEB_UI=55effbf329f67f0322d26c0e
export SG_SSH=55c7274d29f67f6c2fdf0c98

export ROCKS_DB=569cef5e29f67f2c7ae17138
export MAP_DB=57d8d0f929f67f06e9198020
export OFF_HEAP=57d8d18b29f67f06e9198021
...
export MANAGER=588620c929f67f0c0af39985
...
export NEWMAN_NIGHTLY_SUITES=${ROCKS_DB},${MAP_DB},${OFF_HEAP},${DISCONNECT},${ESM_SECURITY},${WAN},${MONGO_DB},${HTTP_SESSION},${ESM},${SECURITY},${DOTNET},${JETTY9},${WEB_UI},${MANAGER},${MANAGER_SECURITY}

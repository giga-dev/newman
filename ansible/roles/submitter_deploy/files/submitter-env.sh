...
#SUITES TO RUN
export NEWMAN_SUITES=${XAP_CORE},${SERVICE_GRID},${WEB_UI},${SG_SSH}
export NEWMAN_NIGHTLY_SUITES=${ROCKS_DB},${MAP_DB},${OFF_HEAP},${DISCONNECT},${ESM_SECURITY},${WAN},${MONGO_DB},${HTTP_SESSION},${ESM},${SECURITY},${DOTNET},${JETTY9}

...
# temporary not running rocksdb, mapdb, offheap
export NEWMAN_NIGHTLY_SUITES=${DISCONNECT},${ESM_SECURITY},${WAN},${MONGO_DB},${HTTP_SESSION},${ESM},${SECURITY},${DOTNET},${JETTY9},${WEB_UI}